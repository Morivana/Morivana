...
const staticRoutes = [
  {
    ...
    content: `
      ...
      <section style="margin-top: 24px;">
        ...
        <p>Morivaná is formulated to be a pure daily companion. It contains no artificial sweeteners like sucralose or aspartame, which have been linked to gut microbiome disruption. Instead, we sweeten our greens powder naturally with a standardized extract of monk fruit from Guangxi, China, providing a clean, calorie-free sweetness without blood sugar spikes. We also exclude common fillers like soy, gluten, dairy, and proprietary extracts. Everything you see on our label is exactly what you get: 8 whole plants working together to support your daily wellness, digestion, and natural metabolic energy.</p>
        <p>By focusing on whole food inputs, Morivaná provides bioavailable nutrients that your body recognizes and absorbs efficiently. The iron and calcium from moringa, the complete proteins from spirulina, and the prebiotic fibers from chicory inulin work in harmony to optimize your morning routine. Whether you are in India or Canada, Morivaná is designed to fit seamlessly into your active lifestyle, helping you start each day calm, clear, and quietly fueled.</p>
      </section>
    `
  },
  {
  ...
  {
    path: 'compare',
    title: 'Morivaná vs AG1 vs Setu vs Oziva | Honest Comparison India',
    description: 'Honest comparison of the best greens powders in India. Morivaná vs AG1, Setu, and Oziva — compared on price, ingredients, sourcing, and transparency.',
    h1: 'Morivaná vs AG1 vs Setu vs Oziva',
    h2s: [
      'Side-by-Side Super Greens Comparison',
      'Morivaná vs AG1 (Athletic Greens)',
      'Morivaná vs Setu vs Oziva'
    ],
    content: `
      <section>
      ...
      <section style="margin-top: 24px;">
        <h2>Morivaná vs AG1 (Athletic Greens)</h2>
        ...
        <p>In contrast, Morivaná is designed locally and ships directly. Rather than using 75 trace ingredients (many of which are underdosed to fit in a single scoop), we focus on 8 highly concentrated, transparent whole plants. By sourcing our moringa, amla, and ginger directly from clean farms in India, we keep quality high and costs low, offering a practical, clean, and locally-sourced alternative at a fraction of the cost.</p>
      </section>
      <section style="margin-top: 24px;">
        <h2>Morivaná vs Setu vs Oziva</h2>
        ...
        <p>Morivaná offers a cleaner, simpler alternative. By including exactly 8 whole plants and no proprietary blends, we ensure you know exactly what you are consuming. We avoid synthetic vitamins entirely, relying on organic Amla for Vitamin C and Moringa for iron and calcium. Sweetened with premium monk fruit, Morivaná provides a smoother, cleaner taste profile without any artificial aftertaste, making it the perfect daily greens companion for vegetarian and vegan diets.</p>
      </section>
    `
  },
  {
    ...
    content: `
      <section>
        ...
        <p>Building a new wellness habit only works if it is simple and fits easily into your daily routine. That is why we designed Morivaná to be the easiest part of your morning. You do not need a blender, a complex recipe, or clean-up time. The entire process takes just 30 seconds. First, add one scoop (5 grams) of our green powder into your shaker bottle or glass. Second, pour in 200–300ml of cool or room-temperature water. Third, shake or stir vigorously for 15–30 seconds until the powder is fully dissolved, and drink immediately.</p>
        <p>Because Morivaná is made from cold-dried, finely ground plants, some natural settling is normal if the glass sits. We recommend drinking it right after mixing to enjoy the fresh, citrusy flavor at its best. If you find the natural green taste strong at first, you can easily start with half a scoop in a larger volume of water and work your way up to a full scoop over a week.</p>
      </section>
      <section style="margin-top: 24px;">
        <h2>Optimal Timing for Maximum Absorption</h2>
        <p>When you consume your daily greens matters just as much as how you mix them. For best results, we recommend making Morivaná your first morning ritual on an empty stomach, about 15–30 minutes before your coffee, tea, or breakfast. Taking it fasted allows your digestive tract to absorb the vitamins, minerals, and antioxidants efficiently without competing with other foods.</p>
        <p>The natural B vitamins and iron from moringa and spirulina support your body's waking energy cycles, helping you feel alert and clear-headed as you start your day. The ginger root works early to settle your stomach, preparing your gut for optimal digestion throughout the afternoon. If you miss your morning dose, you can still take Morivaná later in the day, but we recommend avoiding late-evening use as the natural energy-boosting nutrients might interfere with your sleep cycle.</p>
      </section>
      <section style="margin-top: 24px;">
        <h2>Creative Mixing Ideas Beyond Plain Water</h2>
        <p>While plain water is the fastest way to take Morivaná, our citrusy lemon-and-orange-peel flavor profile makes it highly versatile. For an extra refreshing boost, try mixing one scoop with cold coconut water — the natural potassium and electrolytes create a delicious morning hydration drink. You can also stack your antioxidants by shaking it with iced green tea or fresh orange juice. The Vitamin C in orange juice further enhances the absorption of plant-based iron from our moringa and spirulina.</p>
        <p>If you enjoy a morning smoothie, simply toss a scoop of Morivaná in with your favorite fruits, greens, and plant-based milk. If you prefer a warm drink in the winter, you can mix it with warm oat or almond milk. However, make sure to keep the liquid below 50°C (warm to the touch, not boiling), as excessive heat can degrade the heat-sensitive Vitamin C from amla and active digestive enzymes from orange peel.</p>
      </section>
    `
  },
  {
    ...
    content: `
      <section>
        ...
        <p>We believe that a daily greens supplement should be made from real, whole foods that your body can easily recognize and utilize. Many commercial greens powders rely on synthetic vitamin fortifications and chemical extracts. Morivaná is different. Our formula consists of exactly 8 whole plants, cold-dried and weighed. We disclose every single amount on our label so you know exactly what is going into your body. No proprietary blends, no hidden fillers, and no synthetic additives. Just pure, clean plant nutrition.</p>
  ...
  },
  {
    ...
    h1: 'Pre-Order Morivaná',
    content: `
      <section>
        <h2>Pre-Order Early Bird Offer</h2>
        <p>Thank you for your interest in Morivaná Daily Super Greens. We are currently in our pre-launch phase, preparing our first batch of premium, cold-dried greens. By pre-ordering today, you secure your place in our priority shipping queue and lock in an exclusive 15% early bird discount. A 30-day supply (150 grams, including a measuring scoop) is priced at ₹1,299 in India and CA$19.99 in Canada. This pre-order discount is our way of thanking our early supporters who share our vision of transparent, whole-plant nutrition.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <section style="margin-top: 24px;">
        ...
        <p>Our commitment to sustainability extends to how we package and distribute our product. Standard plastic tubs are bulky, energy-intensive to manufacture, and rarely recycled. Morivaná is packaged in lightweight, flexible, and recyclable pouches that require 70% less plastic and generate a significantly lower carbon footprint during transport. We are continually researching biodegradable film structures to achieve a 100% compostable packaging solution.</p>
        <p>We also offset the carbon emissions generated by our shipping operations to India and Canada through verified carbon reduction projects. Sourced sustainably, processed gently, and packaged responsibly, Morivaná is designed to optimize your health while respecting the earth. We believe that clean nutrition should never come at the expense of our shared environment.</p>
      </section>
    `
  },
  {
    ...
    content: `
      ...
      <section style="margin-top: 24px;">
        ...
        <p>All content displayed on this website — including text, copy, graphics, logos, brand names, product photography, 3D interactive models, and site layout — is the intellectual property of Morivaná and is protected by copyright and trademark laws. You may not copy, reproduce, distribute, modify, republish, or create derivative works from any part of this site without our express prior written authorization. You are granted a limited, non-exclusive license to access and view the website for personal, non-commercial use only.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <section style="margin-top: 24px;">
        ...
        <p>We are excited to bring Morivaná to active individuals in both India and Canada. Our supply chain is optimized to distribute directly to customers in these two regions, ensuring freshness and fast delivery times. When we launch, early-bird orders will ship directly from our regional fulfillment centers, avoiding high import duties or long international shipping delays for our Canadian and Indian customers.</p>
        <p>Waitlist members will receive a notification 7 days before orders officially open, giving you ample time to plan your morning routine. Whether you are looking to support your daily energy, improve your digestion, or boost your immune health, Morivaná is designed to be the simplest, cleanest 30-second habit of your day. Sign up now and secure your launch discount.</p>
      </section>
    `
  },
  {
    ...
    content: `
      ...
      <section style="margin-top: 24px;">
        ...
        <p>Taking Morivaná takes just 30 seconds, making it easy to build a consistent habit. Simply add one scoop (5 grams) of our greens powder into 200–300ml of cool or room-temperature water. Shake or whisk thoroughly for 15–30 seconds until dissolved and drink. For optimal nutrient absorption, we recommend taking Morivaná first thing in the morning on an empty stomach, 15 minutes before your breakfast, coffee, or tea. This allows the prebiotic fibers and vitamins to settle your gut and support your cellular energy cycles as you begin your day.</p>
        <p>If you prefer, you can also mix Morivaná with fresh coconut water, cold brew tea, orange juice, or blend it directly into your morning smoothie. We test every single batch of our daily greens powder through certified third-party laboratories for heavy metals, pesticides, and microbial purity, ensuring that you receive the cleanest, safest, and most effective product possible.</p>
      </section>
    `
  },
]
  ...
  const customRootContent = `
    <div id="root">
      ...
      <footer style="display: none;">
        <p>© 2026 Morivaná. All rights reserved. Sourced and distributed in India & Canada. Contact: Morivana.daily@gmail.com</p>
      </footer>
    </div>
  `
