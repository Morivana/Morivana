...
const FAQ_ITEMS = [
  {
    question: 'What makes Morivaná Daily different from other daily greens powders?',
    answer: 'Unlike other greens powders that use proprietary blends and synthetic vitamin packs, Morivaná Daily is made from exactly 8 whole plants. We rely on organic, nutrient-dense whole foods like Moringa oleifera, spirulina, and amla to deliver natural iron, calcium, and vitamin C. There are no synthetic fillers, no artificial sweeteners, and no hidden ingredients. What you see on our label is exactly what goes into your morning scoop.'
  },
  {
