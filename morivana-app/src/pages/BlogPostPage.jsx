  ...
  const schemas = [
    {
      ...
      publisher: { '@type': 'Organization', name: 'Morivaná Daily', logo: { '@type': 'ImageObject', url: 'https://morivanadaily.com/packaging_highres.webp' } },
      mainEntityOfPage: { '@type': 'WebPage', '@id': `https://morivanadaily.com/learn/${post.slug}` },
