  ...
  const schemas = [
    {
      ...
      publisher: { '@type': 'Organization', name: 'Morivaná Daily', logo: { '@type': 'ImageObject', url: 'https://morivandaily.com/packaging_highres.webp' } },
      mainEntityOfPage: { '@type': 'WebPage', '@id': `https://morivandaily.com/learn/${post.slug}` },
