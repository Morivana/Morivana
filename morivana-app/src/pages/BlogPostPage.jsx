  ...
  const schemas = [
    {
      ...
      publisher: { '@type': 'Organization', name: 'Morivaná Daily', logo: { '@type': 'ImageObject', url: 'https://moriavandaily.com/packaging_highres.webp' } },
      mainEntityOfPage: { '@type': 'WebPage', '@id': `https://moriavandaily.com/learn/${post.slug}` },
