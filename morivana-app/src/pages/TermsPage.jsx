    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', lineHeight: 1.7, fontSize: '0.98rem' }}>
          <p>
            Welcome to Morivaná. By accessing or using our website at <strong>morivana-web.onrender.com</strong>, you agree to comply with and be bound by these Terms of Use.
          </p>
