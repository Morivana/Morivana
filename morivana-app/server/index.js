...
const allowedOrigins = ALLOWED_ORIGIN
  ...
  : ['https://www.moriavandaily.com', 'https://moriavandaily.com', 'https://www.morivana.com', 'https://morivana.com', 'https://morivana.pages.dev']
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", 'data:', 'https://www.moriavandaily.com', 'https://moriavandaily.com', 'https://www.morivana.com', 'https://morivana.com', 'https://morivana.pages.dev'],
      connectSrc: ["'self'", 'https://api.clerk.com', 'https://ipapi.co', 'https://challenges.cloudflare.com', 'https://moriavandaily.com', 'https://morivana.pages.dev'],
    },
  },
  hsts: {
